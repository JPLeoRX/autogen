package com.tekleo.autogen.template_engine.text;
...
public class TextFileParser {
    ...
    public static String readFromFileInResourcesFolder(String pathToFileInResourcesFolder) {
        TextFileParser parser = TextFileParser.buildForFileInResourcesFolder(pathToFileInResourcesFolder);
        parser.read();
